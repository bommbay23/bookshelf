...
document.addEventListener('DOMContentLoaded', function () {
    ...
    inputBook.addEventListener('submit', function (a) {
        a.preventDefault();
        ...
        if (isDuplicate) {
            ...
            // Memperbarui tampilan rak 
            updateBookshelf();

            // Mengosongkan input setelah menambahkan buku
    ...
    // Fungsi untuk memperbarui tampilan rak 
    ...
    function createBookItem(book) {
        ...
        let toggleButton;
        if (book.isComplete) {
            toggleButton = createActionButton('Belum selesai di Baca', 'green', function () {
